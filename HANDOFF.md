...
Live on **positron.studio**, **22 of 26 demos built, 305/305 green**. This
...
**305/305 green.** 22 of 26 built; `20`–`22` are archive pages that work and are
...
```sh
node demo/verify.mjs          # every built demo, CDP/Chrome — 305 asserts
