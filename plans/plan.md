...
`HANDOFF.md`, then `SUMMARY.md`, then `plans/plan-timeline.md` §7–§9. What is here is
...
**Many-to-many (the participatory grid) is planned separately in `plans/plan-m2m.md`** (2026-08-25 session 4):
...
p50 92 ms; 2-way 74 ms = the WHEP baseline exactly.** Phase-1 details in plans/plan-m2m.md §6.
