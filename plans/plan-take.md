...
`plans/plan-score.md` §4b for what a media part becomes once it enters the container.
...
- **Any content anchor.** "The wall-clock instant this frame was captured,
  against timeline zero" is precisely what `plans/plan-glass.md` P0 blocks:
