...
belongs in the score container as *parts* (`plans/plan-score.md` §4b) rather than
...
So this plan is about **vClick scores only**. The rest is `plans/plan-score.md`'s P5.
...
- **What the p-fields MEAN is unknown to us**, by design (`plans/plan-score.md` §1).
